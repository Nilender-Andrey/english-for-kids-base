export const Category = [
  ...
  'Food', 'City', 'Main Page', 'Statistic'/* , 'Login' Поправь на 3 в showStatistics() */];

export const CardsCategory = [
  {
    heading: 'Action (set A)',
    image: 'img/dance.jpg',

  },
  {
    heading: 'Action (set B)',
    image: 'img/play.jpg',
  },
  {
    heading: 'Animal (set A)',
    image: 'img/cat.jpg',
  },
  {
    heading: 'Animal (set B)',
    image: 'img/fish1.jpg',
  },
  {
    heading: 'Clothes',
